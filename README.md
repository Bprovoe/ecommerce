...
## Testing 
Test responsibility on multiple devices and simulators. 
- Tested on windows laptop
- Tested on Mac desktop
- Tested on Iphone 7
- Tested on friend�s droid
- Tested on sister�s ipad 

Added items in tons of different orders. Refreshed the page and tried again. Did this on Internet Explorer and Chrome. I also had my friend wit the droid test out the cart.

My final test after every step was to use the HTML validator.
